...
- _EXTENDED VERSION - Optimal Decision-Making for Autonomous Agents via Data Composition.pdf_ is an extended, one column version of the article, where proofs are given in more detail.
