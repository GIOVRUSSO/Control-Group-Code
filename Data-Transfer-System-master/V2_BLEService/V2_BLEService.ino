/* This is version 2 of data transfer system
 *  
 *  Jingyi Hu - jingyi.hu@ucdconnect.ie
 *  
 *  This version file was working when the arduino connected to the onePlus phone, and AUX function was disabled
 *  
 *  However, after AUX function set to limit - PAS level, and connect to another phone, only the first four messages can be sent successful
 *  this program always stuck on the phase when assign the third package of 5th messeage value to Bike.Char  
 *  
 *  So for the further work, I suggest the developer continue improving this scripes and make it fully working
 *  
 *  
 */
