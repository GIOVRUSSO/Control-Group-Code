...
#Foe (uncontrolled car) info (start, departure time and ending edge)
foeSt = foeArray[0]
...
if __name__ == '__main__':
    ...
    while step < 45001:
        ...
        foesInSim = 0 #Counting the uncontrolled cars can be useful for more developed logging functions, hence htis is left here
        for i in range(n_foes):
            foeID = 'foe.' + str(i)
