import rospy
from mpc_controller_2_2 import *
...
plt.savefig('/home/adamo/catkin_ws/src/rover_navigation/src/klc_passive_dynamic/' + str(mode) + '/xKLC_PM_online_real.png')
...
ax.fill_between(x, (y-ci), (y+ci), color='b', alpha=.1)
plt.savefig('/home/adamo/catkin_ws/src/rover_navigation/src/klc_passive_dynamic/' + str(mode) + '/yKLC_PM_online_real.png')
