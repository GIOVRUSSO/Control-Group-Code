import rospy
from mpc_controller_2_1 import *
...
targetx = 0.3*np.load('./waypoints2/wx_2_1.npy')
targety = 0.3*np.load('./waypoints2/wy_2_1.npy')
...
target = [targetx[-1],targety[-1]] #target position
