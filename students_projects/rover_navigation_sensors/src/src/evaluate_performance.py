...
print("/home/adamo/catkin_ws/src/husky_mpc_datadriven/src/data/dynamic_" + str(mode) + "/klc_"+ online + real + "planning_" + str(mode) + ".npy")

"""planning = extract_data_from_dataset("/home/adamo/catkin_ws/src/husky_mpc_datadriven/src/data/dynamic_" + str(mode) + "/klc_"+ online + real + "planning_" + str(mode) + ".npy")
simulation = extract_data_from_dataset("/home/adamo/catkin_ws/src/husky_mpc_datadriven/src/data/dynamic_" + str(mode) + "/klc_"+ online + real + "simulation_" + str(mode) + ".npy")
speeds = extract_data_from_dataset("/home/adamo/catkin_ws/src/husky_mpc_datadriven/src/data/dynamic_" + str(mode) + "/inputs_for_husky_" +real +"klc_"+ online + str(mode) + ".npy")
"""

planning = extract_data_from_dataset("/home/adamo/catkin_ws/src/husky_mpc_datadriven/src/data/dynamic_0/klc_online_real_planning_0.npy")
simulation = extract_data_from_dataset("/home/adamo/catkin_ws/src/husky_mpc_datadriven/src/data/dynamic_0/klc_online_real_simulation_0.npy")
